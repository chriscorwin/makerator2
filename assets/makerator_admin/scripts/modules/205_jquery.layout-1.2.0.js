			...
			if (o.closable) {
				...
				if (o.togglerContent_open) // ui-layout-open
					$("<span>"+ o.togglerContent_open +"</span>")
						.addClass("ui-layout-content ui-layout-content-open")
	...
	var sizeHandles = function (panes, onInit) {
		...
		$.each(panes.split(","), function() {
			...
			if ($T) {
				...
				var
					$TC_o = (o.togglerContent_open   ? $T.children(".ui-layout-content-open") : false)
				,	$TC_c = (o.togglerContent_closed ? $T.children(".ui-layout-content-closed")   : false)
